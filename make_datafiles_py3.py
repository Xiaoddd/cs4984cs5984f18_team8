...
# require python 3
# code from https://github.com/becxer/cnn-dailymail/blob/master/make_datafiles.py
# python 2 version here: https://github.com/chmille3/process_data_for_pointer_summrizer/blob/master/make_datafiles.py
...
all_urls = "url\\all_urls.txt"  # This should be in the local directory

tokenized_stories_dir = "tokenized_stories"
cnn_tokenized_stories_dir = dm_tokenized_stories_dir = tokenized_stories_dir
    ...
    with open(out_file, 'wb') as writer:
        for idx, s in enumerate(story_fnames):
            ...
            if os.path.isfile(os.path.join(tokenized_stories_dir, s)):
                ...
                raise Exception("Tokenized stories directory %s contains correct number of files but story file %s found in neither." % (tokenized_stories_dir, s))
